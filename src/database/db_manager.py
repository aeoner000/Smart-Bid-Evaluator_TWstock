...
from src.database.schemas import create_table_sql
...
class IPO_DAO:
    ...
    def diff_index(
        ...
        # 轉成 MultiIndex，使迭代時可回傳 tuple
        tuples = [tuple(row) for row in diff_df[key_cols].itertuples(index=False, name=None)]
